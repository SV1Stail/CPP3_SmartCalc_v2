...
class Model {
 public:
  ...
  QHash<QString, double> main_credit_annu(const double &credit_sum,
                                          const double &percent,
                                          const double &srok);
  QHash<QString, double> main_credit_diff(const double &credit_sum,
                                          const double &percent,
                                          const double &srok);
  QHash<QString, double> main_deposit_kapitalizacia(const double &deposit_sum,
                                                    const double &percent,
                                                    const double &srok,
                                                    const double &nalog);
  QHash<QString, double> main_deposit_back_pays_every_month(
